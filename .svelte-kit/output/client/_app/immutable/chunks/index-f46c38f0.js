...
function W(t) {
  ...
  for (let r = e[c] + 1; r != 0; r = i[r - 1]) {
    for (a.push(n[r - 1]); o >= r; o--) l.push(n[o]);
    o--;
  }
  for (; o >= 0; o--) l.push(n[o]);
  a.reverse(), l.sort((r, u) => r.claim_order - u.claim_order);
  for (let r = 0, u = 0; r < l.length; r++) {
    for (; u < a.length && l[r].claim_order >= a[u].claim_order; ) u++;
    ...
    ((u.ctx = e
      ? e(t, n.props || {}, (f, y, ...j) => {
          ...
          return (
            u.ctx &&
              c(u.ctx[f], (u.ctx[f] = S)) &&
              (!u.skip_bound && u.bound[f] && u.bound[f](S), s && rt(t, f)),
            y
          );
        })
      : []),
