...
const Asset = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<foo class="${"py-4 text-lg"}">Name: <b><a href="${
    "assets/" + escape(asset.Name)
  }">${escape(asset.Name)}</a></b> <br>
...
<main class="${"svelte-rowpqd"}">${validate_component(
      Assets,
      "Assets"
    ).$$render($$result, { assets }, {}, {})}
</main>`;
  }
);
