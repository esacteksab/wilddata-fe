...
const U5Bnameu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.org === void 0 && $$bindings.org && org !== void 0)
    $$bindings.org(org);
  $$result.css.add(css);
  return `<main class="${"svelte-1ggd7k"}"><h1 class="${"text-8xl svelte-1ggd7k"}">${escape(org.DisplayName)} Org</h1>

  EMail:<b>${escape(org.EMail)}</b> <br>
  <a href="${escape(org.Name) + "/assets/"}" class="${"svelte-1ggd7k"}">View ${escape(org.DisplayName)} Org Assets</a>
</main>`;
});
